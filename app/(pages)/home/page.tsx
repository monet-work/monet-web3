  ...
  return (
    <main>
      ...
      <section className="bg-background text-white">
        <div className="mx-auto relative max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
          <Spline
            scene="https://prod.spline.design/SCXaqhx0ZDC6BNrz/scene.splinecode"
            className="absolute left-1/2 transform z-10 -translate-x-1/2 top-1/2 -translate-y-1/2 opacity-40"
          />
          <div className="mx-auto max-w-3xl text-center z-50">
            ...
            <div className="mt-8 relative z-50 flex flex-wrap justify-center gap-4">
