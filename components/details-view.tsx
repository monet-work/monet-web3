...
function DetailsView({ isActive, Data }: Props) {
  const [value, setValue] = useState(826);
  if (!isActive)
    return (
      <div className="w-[30%]">
        <Card className=" w-full">
          <CardContent className="flex flex-col pt-4 w-full ">
            ...
            <div className="mt-4 rounded-lg text-lg py-6 flex items-center flex-col gap-4 bg-neutral-900 p-4 ">
              <TextSelectIcon className="w-8 h-8 text-neutral-400" />
              <p className="  text-neutral-400">
                Please select an offer to start trading
              </p>
            </div>
          </CardContent>
